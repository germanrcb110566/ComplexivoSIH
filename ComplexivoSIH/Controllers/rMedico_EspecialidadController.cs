...
namespace ComplexivoSIH.Controllers
{
    public class rMedico_EspecialidadController : Controller
    {
        ...
        {
            ViewBag.alerta = "info";
            ViewBag.msgmodulo = "Visualizar Asignación de Especialidades Médicas".ToUpper();
            ViewBag.acceso = "Acceso A:".ToUpper() + Session["Nombres"] + "........ASIGNADO EL ROL:" + Session["Rol"];
            ViewBag.layout = Session["Layout"];
            var rMedico_Especialidad = db.rMedico_Especialidad.Include(r => r.Catalogo).Include(r => r.mPersona);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.acceso = "Acceso A:".ToUpper() + Session["Nombres"] + "........ASIGNADO EL ROL:" + Session["Rol"];
            ViewBag.layout = Session["Layout"];
            ViewBag.especialidad_id = new SelectList(db.Catalogo.Where(r => r.mcatalogo_id == 6), "catalogo_id", "nombre");
            //ViewBag.medico_id = new SelectList(db.mPersona, "persona_id", "apellidos");
        ...
        public async Task<ActionResult> Create([Bind(Include = "registro_id,medico_id,especialidad_id")] rMedico_Especialidad rMedico_Especialidad)
        {
            ...
            ViewBag.especialidad_id = new SelectList(db.Catalogo.Where(r => r.mcatalogo_id == 6), "catalogo_id", "nombre", rMedico_Especialidad.especialidad_id);
            ViewBag.medico_id = new SelectList(db.mPersona, "persona_id", "identificacion", rMedico_Especialidad.medico_id);
            return View(rMedico_Especialidad);
        }
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            ViewBag.especialidad_id = new SelectList(db.Catalogo.Where(r => r.mcatalogo_id == 6), "catalogo_id", "nombre", rMedico_Especialidad.especialidad_id);
            ViewBag.medico_id = new SelectList(db.mPersona, "persona_id", "apellidos" , rMedico_Especialidad.medico_id);
            return View(rMedico_Especialidad);
        }

...
namespace ComplexivoSIH.Controllers
{
    public class mAtencionsController : Controller
    {
        ...
        {
            ViewBag.alerta = "info";
            ViewBag.msgmodulo = "Visualizar Atención a Pacientes".ToUpper();
        ...
        public async Task<ActionResult> Create([Bind(Include = "atencion_id,cita_id,diagnostico,examenes,receta")] mAtencion mAtencion)
        {
            ViewBag.alerta = "info";
            ViewBag.msgmodulo = "Visualizar Atención a Pacientes".ToUpper();
            ViewBag.acceso = "Acceso A:".ToUpper() + Session["Nombres"] + "........ASIGNADO EL ROL:" + Session["Rol"];
            ...
            ViewBag.cita_id = new SelectList(db.mCita, "cita_id", "motivo", mAtencion.cita_id);
            return View(mAtencion);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "atencion_id,cita_id,diagnostico,examenes,receta")] mAtencion mAtencion)
        {
            ViewBag.alerta = "info";
            ViewBag.msgmodulo = "Visualizar Atención a Pacientes".ToUpper();
            ViewBag.acceso = "Acceso A:".ToUpper() + Session["Nombres"] + "........ASIGNADO EL ROL:" + Session["Rol"];
